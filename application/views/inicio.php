        <div id="contenido">
        	<div id="img_ppal" style="width:895px !important; height:261px;">
                <div id="wrapper" >
            ...
            <div style="height:172px; text-align:left; font-size:20px">
                <div style="float:left; width:298px; height:172px; background-image:url(http://colegiociodemexico.edu.mx/test_new/imagenes/Maquetacion_10.jpg); color:#FFF;" id="cont1"> 
                    ...
                    <a href="ingreso/primaria" style="color:#FFF" target="_blank">
                        Ingreso Primaria<br/>
                    </a>
                </div>       
                ...
                <div style="float:left; width:299px; height:172px; background-image:url(http://colegiociodemexico.edu.mx/test_new/imagenes/Maquetacion_12.jpg); color:#FFF;" id="cont3">
                    <a href="cionet" style="color:#FFF">
                        ...
                        CioNET<br/>
                        <span style="font-size:13px;">Ingreso a Padres de Familia </span>
                    </a>
                </div>    
            </div>                     
            <div id="cuad_blanc" style="height:483px; width:895px; background-color:#FFF; float:none" >            
                <div id="cuad_blanc1" style="float:left; width:524px !important; height:443px; padding:20px; background-color:#FFF;">                  
                    <p style="font-weight:bold; font-size:19px; font-style:italic; color:#3C0;">
                        &quot;El l&iacute;mite entre un sue&ntilde;o y la realidad es la fecha en que quieras realizarlo&quot;
                    </p>
                    <br/>
                    <p style="font-weight:700">Actividades de Valor Agregado</p>  
                    <br/>                    
                    <p>
                        &bull;&nbsp;<a class="fancybox fancybox.ajax" href="<?php echo base_url().'assets/docs/';?>actividades.txt" style="color:#00F">Para Kinder.</a></p>                   
                    <p>
                        &bull;&nbsp;<a class="fancybox fancybox.ajax" href="<?php echo base_url().'assets/docs/';?>actividades_p.txt" style="color:#00F">Para Primaria.</a></p>
                    <br/>
                    <p style="font-weight:700">Horario Extendido y Actividades Extracurriculares</p> <br/>
                    <p>En Colegio CIO de México, contamos con un horario extendido de 7.30 a 5:00 pm para apoyar a los padres de  familia que por cuestiones de trabajo requieren que alguien supervise y apoye a sus hijos a través de actividades dirigidas con costo adicional como son jazz, hip hop, robótica o bien apoyándoles en la supervisión de tareas y ofreciendo nuestro servicio de cafetería.</p><br/>
                    <p><a class="fancybox fancybox.ajax" href="<?php echo base_url().'assets/docs/';?>horario.txt" style="color:#00F">Ver imágenes...</a></p>
                                     
                </div>                
                
                <div id="cuad_blanc2" style="float:left; width:291px; height:443px; padding:20px; background-color:#F0F0F0">                 
                    <p style="font-weight:700">&Uacute;LTIMAS NOTICIAS</p> <br/>
